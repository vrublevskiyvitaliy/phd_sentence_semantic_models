...
class BertEmbeddingsClassic(BertEmbeddings):
...
class BertModelClassic(BertModel):
    """
    ...
    def __init__(self, config, add_pooling_layer=True):
        ...
        self.embeddings = BertEmbeddingsClassic(config)
...
class BertForSequenceClassificationClassic(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.bert = BertModelClassic(config)
        classifier_dropout = (
